...
// Example of using the Sybase MCP Server

// First, start the server with the Sybase connection details:
// node dist/src/index.js sybase '{"host":"","port":,"database":"","user":"","password":""}'
